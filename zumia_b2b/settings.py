"""
Django settings for zumia_b2b project.
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),    #timedelta(minutes=60)    # 🔐 Access token valid for 60 minutes
